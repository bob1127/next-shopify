...
季節の工作をつくろう！</b>
                     <div className="line bg-black h-[2px] w-full ">
                        
                     </div>
                     <div className='items-wrap w-1/2 grid grid-cols-2'>
                        <div className='flex flex-row justify-center'>
                           <img src="https://hugmug.jp/themes/hugmug/common/images/ph_footer_visual.svg" className='icon w-1/2' alt="" />
                        </div>
                        <div>
                ...
                <div className="middle  border-4 border-orange-500 overflow-scroll p-[0px] lg:p-[30px] w-full md:w-[3/4] xl:w-1/3">
                 <b className='text-[20px] font-bold flex justify-center text-center '>FAMILY SNAP</b>
                     ...
                     <img  className='w-full' src="https://www.haruta-shoes.co.jp/catalog/ss2024/_astro/img_model_05_1.4QlxG1uu_Z1OcJfJ.webp" alt="" />
                     ...
                     <a href="" className='border p-2 w-[100px] text-[14px] mt-3 border-black mt-3 rounded-[30px] text-center inline-block mx-auto'>Buy now</a>
                     ...
                     <div className="bottom-div bg-[#c9b1df] p-[40px]">
                        <div className="img bg-white border border-black w-full rounded-[7px]">
                            ...
                            <div className="txt p-10 relative">
                                <p className='text-[20px] txet-center font-bold'>LINEお友だち会員募集中！
</p>

                                  <div className='py-6'>
                                      <img src="https://hugmug.jp/themes/hugmug/common/images/ph_footer_visual.svg" className='w-[280px]' alt="" />
                                  </div>
                         ...
                         <b className='text-[10px] inline  mx-auto  w-full text-center'>© 2022 CCG TO Co.Ltd All rights reserved.
</b>
 ...
 <ReactSlick/>
                       <div>
                           <h3 className='text-[20px] text-white text-center font-bold mb-4'>TREND WORD</h3>
                       </div>
                       <div className='flex justify-center items-center flex-wrap border-t-1 border-b-1 py-[40px] border-black'>
                            <a href="" className='border text-black rounded-[30px] border-black text-[16px] bg-fuchsia-200 px-[20px] py-[.5px] mx-1 my-1 flex justify-center items-center'>選購資訊與蝦皮賣場</a>
                              <a href="" className='border text-black rounded-[30px] border-black text-[16px] bg-fuchsia-200 px-[20px] py-[.5px] mx-1 my-1 flex justify-center items-center'>寵物飼養教學</a>
                                <a href="" className='border text-black rounded-[30px] border-black text-[16px] bg-fuchsia-200 px-[20px] py-[.5px] mx-1 my-1 flex justify-center items-center'>居家整理</a>
                                  <a href="" className='border text-black rounded-[30px] border-black text-[16px] bg-fuchsia-200 px-[20px] py-[.5px] mx-1 my-1 flex justify-center items-center'>其他項目 </a>
                           
                       </div>
                       <img src="https://hugmug.jp/uploads/2024/06/LINE2407_present_side-banner.jpg.webp" className='w-full' alt="" />
                </div>
            </section>
            <section className='marquee_section mt-[60px] bg-gray-50 mt-[70px] lg'>
                ...
                <div className='flex flex-row justify-center w-full'>
                 ...
                 <Marquee pauseOnHover	 className='wrap py-[50px] mt-6 w-[80%] overflow-hidden'>
                    ...
                    <div>
                        <div className='border flex justify-center items-center hover:bg-[#c9b1df] duration-100 border-black w-[400px] p-6 rounded-[65px] mx-3'>
                            <img src="https://www.nikoand.jp/wp-content/uploads/2024/07/bnr_town_guide_tokai_a_1080_1080.jpg" className='border-3 rounded-full border-black w-[70px] h-[70px]' alt="" />
                            <a href="" className='text-[12px] hover:font-bold ml-4'>「niko and ...」発のフェミニン雑貨ブランド「tiny tiny」の2号店が「ルミネ大宮」に8月8日(木)NEWオープン</a>
            ...
            <section className='bg-[#333] h-[80vh]'>
