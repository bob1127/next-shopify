...
{/*
    ...
    <div>
      ...
      <div className="bg-white ">
        <div className="sideBar z-[999999] bottom-[23%] right-[-90%] fixed inline-flex border h-[1px]  flex-col justify-center  items-center ">
          <p className="font-bold px-4 inline-block rotate-[90deg] border bg-blue-300 border-black text-[13px] ml-[64px] text-black">
            CHAPTER-1 KIDS COORRDINATE 8DAYS
          </p>
          <a
            className="fixLink mt-[150px] w-[90px] pc is-visible"
            id="fixLink"
            href="https://www.beams.co.jp/tag/kids24ss_all/"
            target="_blank"
          >
            <span class="link">
              <svg
      ...
      >
        <div className="flex flex-col justify-center items-center">
          ...
          <div className="bottom_txt mx-auto w-full lg:w-[700px]">
            ...
            <a
              href="/"
              className="flex mx-auto flex-col border-2 border-white rounded-[50px] w-[220px] py-2 text-white justify-center items-center mt-[30px]"
            >
              Go Shopee
            </a>
          </div>
      ...
      <div>
        ...
        <div className="bottom-wrap flex flex-col lg:flex-row p-[15px] lg:p-8">
          ...
          <div className="right  md:p-[50px] lg:p-[0px] p-[0px] w-full lg:w-[38%]">
            ...
            >
              <div className="title">
                <b className="text-center bg-[#3b454b] text-[18px] font-bold">
    ...
    <section className="h-[100vh] xl:h-[130vh]">
      <div className="flex w-full justify-center items-center flex-col">
        <Tabs aria-label="Options" className="bg-transparent">
          ...
          >
            <Card>
              <CardBody>{/* <SwiperCarousel01/> */}</CardBody>
            </Card>
          </Tab>
          <Tab
            key="music"
          ...
          >
            <Card>
              <CardBody>{/* <SwiperCarousel02/> */}</CardBody>
            </Card>
          </Tab>
          <Tab
            key="videos"
