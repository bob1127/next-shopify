    ...
    <div className="bg-[#f1f0ee] py-[100px]">
      ...
      <section className="h-full  bg-white border-3 border-gray-200 rounded-2xl m-7 py-[80px]">
        <div className="txt border border-gray-400">
          ...
          <div className="wrap flex-col flex lg:flex-row justify-center items-center ">
            <div className="left ml-0 bg-fixed bg-contain lg:ml-[-100px] w-full lg:w-[50%] delay-75 duration-300 hover:scale-0 md:hover:scale-[1.15] bg-[url('https://www.nikoand.jp/wp-content/uploads/2024/07/bnr_town_guide_tokai_a_1080_1080.jpg')] hover:w-[70%] bg-gray-500 rounded-2xl h-[450px]"></div>
            <div className="right w-full pl-0 lg:pl-[40px] flex justify-center items-center lg:w-[60%]">
              <div className="txt w-[90%] lg:w-[70%] py-[50px]">
                ...
                <h4 className="text-[60px] pb-[-30px] font-extrabold bg-[#7ccdf3] ">
                  WIRE FRAME
                </h4>
                <p className="w-full">
                  Achieve your first draft in the first minute. Sit back and
                  watch AI magically turn your Sitemap into wireframes in one
                  click generating real components un-styled with copy. Getting
                  sign off has never been so easy.
                </p>
                <div className="grid mt-4 p-8 grid-cols-1 md:grid-cols-2">
                  <div className=" m-[30px]  p-[15px] border-black rounded-xl border-2 ">
                    <div className="txt">
                      <div className="img border-2 border-black rounded-full my-[10px] w-[40px] h-[40px]"></div>
                      <b>No1</b>
                      <p className="text-[12px]">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit.
                        Facere maxime alias officia sunt, ipsam unde
                      </p>
                    </div>
                  </div>
        ...
        <div className="wrap w-full justify-center items-center flex-wrap px-[20px] md:px-[50px] lg:px-[110px] flex flex-row">
          <div className='border duration-750 overflow-hidden hover:bg-[#cce7a4]   data-aos="fade-right" data-aos-delay="450"  m-[10px] w-full md:w-[360px] border-black bg-white rounded-xl'>
            <div className="txt py-[15px]">
              ...
              <p className="text-[13px] text-center w-2/3 mx-auto">
                {" "}
                Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                Voluptatem dignissimos quos voluptate aut eos? Vitae repudiandae
                et ullam quasi omnis optio eos enim non, natus soluta eum,
                inventore praesentium. Mollitia.
              </p>
            </div>
            <div className="img">
              <Image
                ...
                data-aos-delay="450"
                loader={myLoader}
                className="mb-[-130px] ml-[-140px] scale-[0.75]"
                width={800}
                height={500}
                src="658e3bcd32cb3de9f0460562_Styled%20Wireframe%20Image%202.svg"
              ></Image>
            </div>
          </div>
          ...
          <div className="border duration-750 overflow-hidden hover:bg-[#cee1e9] delay-75 m-[10px] w-full md:w-[360px] border-black bg-white rounded-xl">
            <div className="txt py-[15px]">
              <h4 className="text-[32px] text-center">UI STYLE GUID</h4>
              <p
                className="text-[13px] text-center  w-2/3 mx-auto"
      ...
      <section className="bg-[#0f6efd] relative">
        <div className="banner01 h-[100vh]  overflow-hidden relative">
          <div
            className="img w-[1100px]  z-[999] absolute bottom-[-1000px] left-[16%]"
            data-aos="fade-up"
            data-aos-delay="200"
          >
            <img
          ...
          <div
            className="txt  absolute  left-[15%] top-[0px] z-[99]"
            data-aos="fade-down"
            data-aos-delay="650"
          >
            <h3 className="text-white leading-normal text-[320px] font-extrabold ">
              EAT UP
            </h3>
          </div>
        </div>
        <div
          className="txt  absolute left-[6%] bottom-[90px] z-[999999]"
          data-aos-duration="500"
          data-aos="zoom-in-up"
          data-aos-delay="700"
        >
          <p className="text-[16px] mx-auto text-white text-center w-[60%]">
            ...
            food. de our wonderful world of vertical farms, freshness runs free,
            bland gets banished, and smart produce secures the future of{" "}
          </p>

          <Link
            href="/products"
            className="mt-7 border-2 bprder-white inline-block text-[14px] ml-[40%] font-bold text-black bg-white rounded-[30px] text-center w-[200px] p-3"
          >
            BUY NOW
          </Link>
        </div>
