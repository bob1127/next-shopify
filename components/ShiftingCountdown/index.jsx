...
const COUNTDOWN_FROM = "2024-7-24";
...
const CountdownItem = ({ unit, text }) => {
  ...
  return (
    <div className="flex  h-36 w-1/4 flex-col items-center justify-center gap-1 border-r-[1px] border-slate-200 font-mono md:h-36 md:gap-2">
