  ...
  return (
    <div className="flex flex-col justify-center items-center">
          ...
          <SwiperSlide className=" w-full  ">
            <Card className="pt-4 bg-white p-0 m-0 shadow-none">
              ...
              <CardBody className="  p-0 m-0">
                <div className="img flex justify-center items-center p-[50px]">
                  <Image
                    loading="lazy"
                    alt="Card background"
                ...
                <div className="description bg-card-2 p-5">
                  ...
                  <a
                    href=""
                    className="border border-black text-black p-2 text-[12px] font-bold rounded-[30px] w-[190px] hover:bg-white duration-200 mt-5"
                  >
                    BUY NOW
                  </a>
                </div>
      ...
      <div className="bg-white w-full min-h-[200px] flex items-center justify-center">
        <button className="px-6 py-2 font-medium bg-card-2 text-white w-fit transition-all shadow-[3px_3px_0px_black] hover:shadow-none hover:translate-x-[3px] hover:translate-y-[3px]">
          選購更多商品！！！
        </button>
      </div>
    </div>
