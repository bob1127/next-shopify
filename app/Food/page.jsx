...
<div className="bg-[#f1f0ee] py-[100px]">
      ...
      <section className='h-full  bg-white border border-gray-50 rounded-2xl m-7 py-[80px]'>
        <div className="txt border border-gray-400">
            ...
            <div className="wrap flex-col flex lg:flex-row justify-center items-center">
                <div className="left ml-0 lg:ml-[-100px] w-full lg:w-[50%] delay-75 duration-300 hover:scale-[1.15] hover:w-[70%] bg-gray-500 rounded-2xl h-[450px]">

                    
                    
                </div>
                <div className="right hover:scale-[0.86] flex w-full justify-center items-center lg:w-[50%]">
      ...
      <section>
        <div className="wrap w-full px-[200px] flex flex-row">
            <div className='border w-1/3 border-black'>
                <div className="txt">
                    <h4 className='text-[40px] text-center'>UI STYLE GUID</h4>
                    <p className='text-[13px] text-center'>    Lorem ipsum dolor, sit amet consectetur adipisicing elit. Voluptatem dignissimos quos voluptate aut eos? Vitae repudiandae et ullam quasi omnis optio eos enim non, natus soluta eum, inventore praesentium. Mollitia.
</p>
