...
const App = () => {
  ...
  return (
    <section className='section_track h-[100vh] relative border-1 border-black'>
      <nav>
        <div className="logo">
          <a href="#">Cochi La</a>
        </div>
      ...
      <div className="wrapper">
        ...
        <div className="container">
          <div>
            <p className="text-[90px] text " href="#">Instagram</p>
          </div>
          <div>
            <p className="text-[90px] text " href="#">Behance</p>            <p className="text-[90px] text " href="#">Facebook</p>
          </div>
          <div>
            <p className="text-[90px] text " href="#">LinkedIn</p>
          </div>
        </div>
      </div>
    </section>
