...
import HeroSlider from "../components/HeroSlider/page.jsx";
import {
  Dropdown,
  DropdownTrigger,
  DropdownMenu,
...
export default async function Home() {
  ...
  return (
    <div className="">
      <link
        rel="alternate"
        href="https://www.ultraehp.com/index.html"
        hreflang="zh-Hant"
      />
      <link
        rel="alternate"
        href="https://www.ultraehp.com/en/index.html"
        hreflang="en"
      />
      ...
      <meta
        key="description"
        name="description"
        content="Ultra Micro-electrode,Ultra Healty-life. Our proud PotentioStrip patented technology brings you two major brands. The first is Ultrapeace, designed for medical and health care-Instant BUT for H.pylori. The second is the Disposable Calibration-free pH Testing Series, designed to enhance the testing experience.   "
      />
      ...
      <meta
        property="og:title"
        content="UltraE ｜ Instant H.pylori BUT test, Disposable calibration-free pH meter ｜UltraPeace & hunmming probe"
      />
      <meta
      ...
      <meta
        property="og:image"
        content="https://www.ultraehp/images/nav/UX200.web"
      />
      ...
      <div className="outWrap overflow-hidden ">
        ...
        <div className=" my-[150px]">
            ...
            <div className="wrapper flex flex-col md:flex-row justify-center items-center px-[35px] w-full">
              <div className="w-full md:w-[45%] flex flex-col justify-center items-center">
                <div className="top hover:scale-90 flex  justify-center items-center border-1 border-gray-900 duration-200  duration-200 p-1">
                  <img
                    src="https://www.nikoand.jp/wp-content/uploads/2024/07/UP_main_-W1226%C3%97H1226.jpg"
                ...
                <div className="top border flex-col border-black w-full flex md:flex-row">
                  <div className="left m-2 duration-200 hover:scale-90 p-5 w-full md :w-1/2 border-1 border-black">
                    <img
                      ...
                      className=" w-[500px] md:w-[300px] h-[300px]"
                      alt=""
                    />
                  </div>
                ...
                <div className="bottom p-2">
                  <div className="wrap p-8 bg-[#2b72e5] rounded-[10px]">
                    <div className="top border-b-2 flex justify-start items-center border-black py-4">
                      <p className="text-[20px] text-white">Hot Sales</p>
                      <b className="ml-2 text-[12px]">人気の記事</b>
                    </div>
                    <div className="bottom">
                      <p>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit.
                        Eum impedit accusantium iusto vel? Laboriosam sequi
                        optio consequuntur, distinctio eveniet consequatur cum
                        sapiente cumque odit officiis fugit quod rerum totam
                        illo.
                      </p>
                      <p>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit.
          ...
          {/* <section className="h-[100vh] border-3 border-rose-400">
            <emblaCarousel />
          </section> */}
          ...
          <section className="section_ScrollPallax px-[20px] sm:px-[30px] w-full flex flex-col md:flex-row  hidden justify-center items-start">
            ...
            <div className="middle relative w-full md:w-[30%] overflow-y-scroll bg-[#ECECEC] h-[97.5vh] pb-[30px]">
              <div className="sideBar absolute h-full right-0 top-0 ">
                <div className="items  flexed right-0 left-3 top-3 ">
                  <a
                    href=""
                    className=" block w-[60px] border-black border-2 rounded-[30px] my-6 bg-white rotate-[-90deg] text-center transform origin-center"
                  >
                    MEN
                  </a>
                  <a
              ...
              <div className="inner h-auto flex flex-col justify-center items-center">
                <div className="bg-[#c0c67f] py-6">
                  <img
                    src="https://www.globalwork.jp//static/pages/women/2023aw_lightwarm_outerseries/assets/images/pic_menu_about.gif"
                    alt=""
                    className="w-[80%] mx-auto"
                  />
                  <h3 className="text-[32px] text-white text-center mt-4">
                    LIGHT WARM 保暖衣
                  </h3>
                  <p className="text-white  mt-2 text-[13px] text-center">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    Quasi natus eaque, tempora et minus inventore totam quod
                    accusantium excepturi consequuntur repudiandae. Iste
                    delectus totam quibusdam soluta asperiores dicta
                ...
                <div className="w-full flex flex-row px-3">
                  <div className="p-2 w-1/3">
                    <img
                      src="https://ace-industry.co.jp/danikuru/img/detail1.png"
                      alt=""
                      className=""
                    />
                  </div>
                  <div className="p-2 w-1/3">
                    <img
                      src="https://ace-industry.co.jp/danikuru/img/detail2.png"
                      alt=""
                      className=""
                    />
                  </div>
                  <div className="p-2 w-1/3">
                    <img
                      src="https://ace-industry.co.jp/danikuru/img/detail3.png"
                      alt=""
                      className=""
                    />
                  </div>
                ...
                <div className="txt">
                  <b className="font-bold text-center text-[30px]">
                    PLAY SWITCH
                  </b>
                </div>
                {/* <p className="text-[30px] text-center text-black">HOT SALE</p> */}

                <h4 className="text-[#333]">其他配件</h4>
              </div>
            </div>
          ...
          <div className="w-full  flex-col  md:flex-row flex justify-center items-center border  bg-white border-black">
              ...
              <div>
                <div className="top">
                  <div className="title py-4 flex mx-auto  w-2/3 justify-center items-center flex-col">
                    ...
                    <b className="text-[12px] text-center">
                      高耐久繊維のCORDURA®︎を贅沢にも二重織りでデザイン。
                      裏地だけ糸の太さを変えることで、袖を通した瞬間から
                      暖かみとソフトな肌当たりが実感できる。
                      パンツはセンタークリースのないイージーなスラックスタイプ。
                    </b>
                    {/* <Link
                      href="/toys"
            ...
            <div className="right overflow-hidden relative w-full md:w-1/2 border border-green">
              <img
                src="https://www.dot-st.com/static/docs/studioclip/pages/kazumi_2023september/assets/img/ballet/img_day02_main.jpg"
                className="w-full "
              ></img>
              <div className="txt left-[10%] bottom-[20%] absolute z-[99999]">
                <div className="flex mx-auto flex-col justify-center items-center">
                  <b className="font-extrabold text-white text-[22px]">
                    中田 慎介
                  </b>
          ...
          <div className="w-full  flex-col  md:flex-row flex justify-center items-center border  bg-white border-black">
            <div className="left w-full md:w-1/2 border border-green">
              <img
                src="https://www.dot-st.com/static/docs/studioclip/pages/kazumi_2023september/assets/img/img_mv.jpg"
                className="w-full "
              ></img>
          ...
          <div>{/* <ApplicateCard/> */}</div>

          <div className="w-full flex flex-col  md:flex-row">
            <div className="left iframe-drag w-full md:w-[60%]">
              <iframe
                src="https://my.spline.design/capcopy-d422eebc2e9d45431ef1d4d7c6edf749/"
                frameborder="0"
                width="100%"
                height="500px"
              ></iframe>
            ...
            <div className="right w-full  flex flex-col justify-center items-center md:w-[40%]">
              <h2 className="text-center font-extrabold">The snackback</h2>
              <p className="text-center w-2/3">
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Doloribus tempore nemo qui voluptas placeat! Dolor.
              </p>

              <Link
                href="/toys"
                className="border-2 mt-3 py-1 px-4 border-black  text-[20px] text-center"
              >
                {" "}
                Others Products
              </Link>
